...
N 760 -450 790 -450 {
lab=out3bitdac}
C {3bitdac.sym} 310 -100 0 0 {name=x1}
...
C {devices/vsource.sym} 90 -350 0 0 {name=V3 value="pulse(0 1.8 0 1p 1p 5u 10u)" savecurrent=false}
C {devices/gnd.sym} 90 -320 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 90 -380 0 0 {name=p8 sig_type=std_logic lab=din0}
C {devices/vsource.sym} 210 -260 0 0 {name=V4 value="pulse(0 1.8 0 1p 1p 10u 20u)" savecurrent=false}
C {devices/gnd.sym} 210 -230 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 210 -290 0 0 {name=p9 sig_type=std_logic lab=din1}
C {devices/vsource.sym} 350 -180 0 0 {name=V5 value="pulse(0 1.8 0 1p 1p 20u 40u)" savecurrent=false}
...
C {devices/code_shown.sym} 950 -340 0 0 {name=spice only_toplevel=false value="
.tran 1n 40u
.control
run
plot din0
