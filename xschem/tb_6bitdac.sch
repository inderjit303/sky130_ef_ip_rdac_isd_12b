...
N 1100 -630 1130 -630 {
lab=out6bitdac}
C {6bitdac.sym} 720 -390 0 0 {name=x1}
...
C {devices/code.sym} 880 -360 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/code_shown.sym} 1140 -420 0 0 {name=spice only_toplevel=false value="
.tran 0.002u 32u
.control
run
plot din0
