...
N 930 -730 970 -730 {
lab=out5bitdac}
C {devices/code.sym} 840 -430 0 0 {name=TT_MODELS
only_toplevel=true
...
C {devices/vsource.sym} 240 -460 0 0 {name=V3 value="pulse(0 1.8 0 10p 10p 0.5u 1u)" savecurrent=false}
C {devices/gnd.sym} 240 -430 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 240 -490 0 0 {name=p8 sig_type=std_logic lab=din0}
C {devices/vsource.sym} 360 -370 0 0 {name=V4 value="pulse(0 1.8 0 10p 10p 1u 2u)" savecurrent=false}
C {devices/gnd.sym} 360 -340 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 360 -400 0 0 {name=p9 sig_type=std_logic lab=din1}
C {devices/vsource.sym} 500 -290 0 0 {name=V5 value="pulse(0 1.8 0 10p 10p 4u 8u)" savecurrent=false}
C {devices/lab_pin.sym} 500 -320 0 0 {name=p1 sig_type=std_logic lab=din3
}
C {devices/gnd.sym} 500 -260 0 0 {name=l2 lab=GND}
C {devices/vsource.sym} 280 -270 0 0 {name=V6 value="pulse(0 1.8 0 10p 10p 2u 4u)" savecurrent=false}
...
C {devices/vsource.sym} 600 -380 0 0 {name=V7 value="pulse(0 1.8 0 10p 10p 8u 16u)" savecurrent=false}
...
C {5bitdac.sym} 520 -450 0 0 {name=x2}
